...
func constructFromPrePost(preorder []int, postorder []int) *TreeNode {
	...
	rootVal := postorder[sz-1]
	rightVal := postorder[sz-2]
	index := 0
	...
	root := &TreeNode{
		Val:   rootVal,
		Left:  constructFromPrePost(preorder[1:index], postorder[0:leftSize]),
		Right: constructFromPrePost(preorder[index:], postorder[leftSize:sz-1]),
	}
	return root
}
